...
MM.lang = {
    ...
    loadPluginLang: function(component, strings) {
        ...
        if (!MM.lang.current) {
            MM.lang.current = 'es_mx';
            MM.lang.strings['es_mx'] = [];
        }
        ...
        if (MM.lang.current != 'es_mx') {
            MM.lang.strings['es_mx'][component] = strings;
        }
    },
    ...
    s: function(id, component) {
        ...
        else if (typeof(MM.lang.strings['es_mx']) != 'undefined'
            && typeof(MM.lang.strings['es_mx'][component]) !== 'undefined'
            && typeof(MM.lang.strings['es_mx'][component][id]) !== 'undefined') {
            translated = MM.lang.strings['es_mx'][component][id];
        }

        // If not found yet, we look for the string in the base language file (lang/es_mx.json)
        if (!translated && component == 'core' && MM.lang.base[id]) {
            translated = MM.lang.base[id];
        }

        // If not found yet (for plugins only) we look for the string in the base lang also (plugin/lang/es_mx.json).
